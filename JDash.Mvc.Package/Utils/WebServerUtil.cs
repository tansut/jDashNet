...
namespace JDash.Package.Utils
{
    ...
    internal static class WebDevServerUtils
    {
        ...
        public static string GetWebDevServerPath()
        {
            ...
            if (!paths.Any())
            {
                throw new InvalidOperationException(" ** Only 2008,2010 and 2012 versions of Visual Studio are supported **");
            }
        ...
        public static string StartWebDev(string applicationPath, int? port, string virtualPath,string appPath)
        {
            ...
            if (string.IsNullOrWhiteSpace(virtualPath))
                return string.Format("http://localhost:{0}?applicationPath={1}", avaliablePort, HttpUtility.UrlEncode(appPath));
