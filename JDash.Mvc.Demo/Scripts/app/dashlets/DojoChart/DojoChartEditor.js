	...
	function (language, declare, lang, template, _WidgetBase, _TemplatedMixin, require, domConstruct, TitleEditor, DashletStylesList, xhr) {
	    return declare([_WidgetBase, _TemplatedMixin], {
	        ...
	        loadPresetList: function () {
	            var self = this;
	            xhr.get({
	            	url: "./Scripts/app/dashlets/DojoChart/resources/presets.js", handleAs: "json",
	                load: function (presets) {
	                    if (presets) {
	                        ...
	                        self.presetsNode.selectedIndex = (self._getConfig().selectedPreset) ? parseInt(self._getConfig().selectedPreset) : 1;
	                    }
