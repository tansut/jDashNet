<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Edit.ascx.cs" Inherits="JDash.WebForms.Demo.JDash.Dashlets.FusionCharts.Edit" %>
<div class="form">
    <div class="item">
    ...
    <div class="itemGroup">
        ...
        <asp:DropDownList CssClass="form-control" ID="ctlPresets"  runat="server"></asp:DropDownList>
    </div>
</div>
